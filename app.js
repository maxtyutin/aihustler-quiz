document.addEventListener('DOMContentLoaded', () => {
  ...
  async function submitQuiz() {
    ...
    const stages = [
      { text: "Сохранение ответов...", sub: "Записываем ваши контактные данные в базу участников." },
      { text: "Создание персонального кабинета...", sub: "Инициализируем доступ к платформе AI Hustlers." },
      { text: "Подбор стратегии трафика...", sub: "Анализируем ответы для подбора оптимальных модулей." },
      { text: "Готово! Перенаправление...", sub: "Всё настроено. Открываем закрытую презентацию." }
    ];
    ...
    try {
      ...
      // Delay redirect to allow animations to fully play (3.2 seconds total)
      setTimeout(() => {
